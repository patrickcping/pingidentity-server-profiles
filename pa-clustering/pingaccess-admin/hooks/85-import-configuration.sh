...
#   https://${pahost}:${PA_ADMIN_PORT}/pa-admin-api/v3/config/import
...
#   https://${pahost}:${PA_ADMIN_PORT}/pa-admin-api/v3/config/import/workflows/1
...
then
    ...
    # -d @${STAGING_DIR}/instance/data/data.json \
    # https://${pahost}:${PA_ADMIN_PORT}/pa-admin-api/v3/config/import/workflows > /dev/null
    ...
    _import_http_code=$(
        curl \
            ...
            --output ${_out} \
            https://${pahost}:${PA_ADMIN_PORT}/pa-admin-api/v3/config/import/workflows \
            2>/dev/null
    )
